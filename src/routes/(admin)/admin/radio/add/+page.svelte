<script lang="ts">
    ...
    // Importing Stationbox component
    import Stationbox from "../../../../../components/major/stationbox.svelte";

    // Array to store stations data
    let stations: any = []

    // Array of station codes
    let stationCodes: any = [
    ...
    // Object to get region names
    let regionNames = new Intl.DisplayNames(['en'], {type: 'region'});

    // Function to handle country change
    const changeCountry = async (e: any) => {
        loading = true;
